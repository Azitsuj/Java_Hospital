...
public class Tables {
	...
	public static void printPatientHeader() {
		...
		System.out.println();
		String patientHeader = String.format("| %1$-5s | %2$-20s | %3$-20s |", "Id", "Imię pacjenta", "Nazwisko pacjenta");
	...
	public static void printDoctorHeader() {
		...
		System.out.println();
		String doctorHeader = String.format("| %1$-5s | %2$-20s | %3$-20s | %4$-21s |", "Id", "Imię lekarza", "Nazwisko lekarza", "Specjalizacja lekarza");
	...
	public static void printScheduleHeader() {
		...
		System.out.println();
		String scheduleHeader = String.format("| %1$-5s | %2$-20s | %3$-20s | %4$-16s | %5$-16s |", "Id", "Imię lekarza", "Nazwisko lekarza", "Start", "End");
	...
	public static void printVisitsHeader() {
		...
		String doctorHeader = String.format("| %1$-5s | %2$-5s | %3$-12s | %4$-20s | %5$-15s | %6$-5s | %7$-13s | %8$-20s | %9$-16s | %10$-16s |", "Id w",
				"Id d", "Imię lekarza", "Nazwisko lekarza", "Specjalizacja", "Id p", "Imię pacjenta", "Nazwisko pacjenta", "Początek wizyty", "Koniec wizyty");
		System.out.println(doctorHeader);
		for (int i = 1; i <= 158; i++) {
			System.out.print("-");
		}
